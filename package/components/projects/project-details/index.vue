...
<template>
  ...
  <div class="container-lg">
    ...
    <div class="d-flex flex-md-row flex-column ga-10 mt-10">
      <div class="pr-md-10 pr-4 border-e border-opacity-100">
        <p class="text-subtitle-2 text-secondary opacity-70">Scope of work</p>
      ...
      <div class="pr-md-10 pr-4 border-e border-opacity-100">
        <p class="text-subtitle-2 text-secondary opacity-70">Industry</p>
        <div class="d-flex ga-2 mt-2">
          <span class="text-subtitle-1 font-weight-medium">{{
            post.industry
          }}</span>
      ...
      <div class="pr-md-10 pr-4 border-e border-opacity-100">
        <p class="text-subtitle-2 text-secondary opacity-70">Raised</p>
        <div class="d-flex ga-2 mt-2">
          <span class="text-subtitle-1 font-weight-medium">{{
            post.raised
          }}</span>
      ...
      <div class="">
        <p class="text-subtitle-2 text-secondary opacity-70">Website</p>
        <div class="d-flex ga-2 mt-2">
          <span class="text-subtitle-1 font-weight-medium"
    ...
    <v-row>
      <!-- LEFT SIDE IMAGE -->
      <v-col cols="12" lg="4">
        <h2 class="text-60 text-secondary">Description</h2>
      </v-col>
      <v-col cols="12" lg="8">
      ...
      <v-col cols="12" lg="6">
        <img :src="post.detail_img_2" alt="project inner image" class="w-100" />
      </v-col>
      <v-col cols="12" lg="6">
        <img :src="post.detail_img_3" alt="project inner image" class="w-100" />
      </v-col>
    </v-row>
  </div>
